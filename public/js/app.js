...
function placeOrder(formObject) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/orders', formObject).then(function (res) {
    ...
    }).show(); //kyuki hum message show hote hi redirect kr rhe h to hme thoda hi deikhega message isliye redirection ko delay kr rhe h thoda.
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); //convert back to object//jo home.js me data-set likha tha btn pr usme 'data' predefined hota h apna bs nam hota h jse yha pizza diya hmne to dataset se wo data hme mil jayega jo hmne wha set kiya tha.
...
updateStatus(order); //stripe related and order-now btn related data.
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
    var stripe, card, mountWidget, _mountWidget, paymentType, paymentForm;

    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _mountWidget = function _mountWidget3() {
              _mountWidget = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
                var elements, style;
              ...
              return _mountWidget.apply(this, arguments);
            };

            mountWidget = function _mountWidget2() {
              return _mountWidget.apply(this, arguments);
            };

            _context2.next = 4;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51ISfEzF929MJummc27mjq19FhPVOYFR5HgWCmef3O8OolpqD6OE6wLqVDOSfwmHWrvj5rMB48AqHSZLNV9rwU9fc00gcnSVWq2');

          case 4:
            stripe = _context2.sent;
            //get from stripe site>dashbord>>developers>apikeys.
            card = null;
            ...
            if (paymentForm) {
              paymentForm.addEventListener('submit', function (e) {
                ...
                var formData = new FormData(paymentForm); //formData ek object bn jyaga us form ka.
                ...
                if (!card) {
                  //by default to card null h or agr by card select h tbhi to card variable me data aa rha h uper to agr card nhi h to ye req. nhi jani chahiye.
                  //normal Ajax call
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_app"] = self["webpackChunkpizza_app"] || [];
