...
function  authController() {
    return {
        ...
        postLogin(req, res, next) {
            ...
            passport.authenticate('local', (err,user,info) => {//first param mtlb hmne konsi strategy use ki h or or 2nd param wo h jo passport.js m done() me jo arguments bheje hna hmne wo.
                if (err) {
        ...
        async postRegister(req, res) {
            ...
            User.exists({ email: email }, (err,result) => {//nhyi kis parameter k through filter krna h jase ki yha hum email k through kra ha ki bhyi ya jo email aapin ghaali h wa pehle e h k db m.
                if (result) {//mtlb email mili h db m same.
